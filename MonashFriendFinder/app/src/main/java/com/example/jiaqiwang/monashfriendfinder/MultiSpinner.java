    ...
    class Adapter extends BaseAdapter implements OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null){
                ...
                wrapper=new Wrapper();
                wrapper.textView=(TextView)convertView.findViewById(R.id.textView_msi);
                wrapper.checkBox=(CheckBox)convertView.findViewById(R.id.checkBox_msi);
        ...
        public void onClick(View v) {
            ...
            if(checkBox.isChecked()){
                ...
                if(maxCount>-1&&checkedSet.size()>=maxCount){
                    ...
                    Toast.makeText(MultiSpinner.this.getContext(), String.format("You can only select %s ", selectCount), Toast.LENGTH_SHORT).show();
                    return;
                }
