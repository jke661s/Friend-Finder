...
//    public <T> T getDataAsObject(Class<T> jaxbClass) throws Exception {
//        return getDataAsObject(jaxbClass, jaxbClass.getPackage().getName());
//    }

//    public <T> T getDataAsObject(Class<T> clazz, String packageName) throws Exception {
//        Context jc = Context.newInstance(packageName);
